    ...
    def scrape_data(self):
        ...
        if self.config['website_name'] == 'kfintech':
            ...
            try:
                ...
                securities_allotted = int(card_body.find('span', id='grid_results_ctl02_lbl_allot').text)
                ...
                result_data = {
                    'name': card_body.find('span', id='grid_results_ctl02_Label2').text,
                    # 'category': card_body.find('span', id='grid_results_Label1_0').text,
                    'securities_allotted': securities_allotted,
                    'applied': int(card_body.find('span', id='grid_results_ctl02_Label5').text),
                    'pan': card_body.find('span', id='grid_results_ctl02_lbl_pan').text,
                    'client_id': card_body.find('span', id='grid_results_ctl02_lbl_dpclid').text,
                    'application_number': card_body.find('span', id='grid_results_ctl02_l1').text,
                    'error': None
                    }
